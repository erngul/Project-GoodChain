...
class MenuService:
    ...
    def NodeMenu(self):
        ...
        publicKey = FunctionItem("see public Key", self.accountService.PrintPublicKey)
        privateKey = FunctionItem("see private Key", self.accountService.PrintPrivateKey)
        ...
        menu.append_item(publicKey)
        menu.append_item(privateKey)
        menu.show()